...
function Portfolio(){
    return(
        ...
        <dir className={styles.sectionPortfolio__divProjects}>
            <ProjectCard linkView ="https://super-games.vercel.app/login" 
            linkGithub ="https://github.com/JosueElutiche24/SuperGames" 
            Title="Super Games" Image="/projectImages/SuperGames.jpeg" 
            ...
            ConocimientosEmpleados="Sistema de registro de usuarios, rutas protegidas y generación de tokens almacenados en cookies utilizando JsonWebToken, control de diversos useEffect y useStates para la creación de los controles de los juegos, se utilizó arrays bidimensionales para buscaminas y snake. El backend fue construido en el mismo proyecto sobre Next js con una estructura de  Api rest, con una base de datos Mysql alojada en internet con el servicio de  PlanetScale." 
            Tecnologias={["React","Next Js","Tailwind","JWT","NySql","Vercel","PlanetScale",]}/>

            <ProjectCard linkView ="https://www.jguzman.tk/" 
            linkGithub ="https://github.com/JosueElutiche24/PortafolioProfesional" 
            Title="Mi sitio Web" Image="/projectImages/Portfolio.jpeg" 
            Collection={["/Project1/img1.jpeg","/Project1/img2.jpeg","/Project1/img3.jpeg","/Project1/img4.jpeg","/Project1/img5.jpeg"]} 
            ...
            ConocimientosEmpleados="En el desarrollo de este proyecto se utilizó: Principalmente un alto nivel de Css. Buen manejo de componentes y Hoocks de react. Implementación del formulario de contacto con API de Gmail. Despliegue del sitio web en hosting y adquisición de un dominio propio." 
            Tecnologias={["React", "NextJs", "Vercel","emailJS", "Tsparticles","SwiperJs"]}/>
        </dir>
        </section>
    )
}
