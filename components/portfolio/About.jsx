    ...
    return(
        <section className={styles.sectionAbout}>
            <div className={styles.sectionAbout__div1}>
                    <h2 className={styles.sectionAbout__div1__H2} id="AboutArea">Sobre mi :</h2>
                    <div className={styles.sectionAbout__div1__Flexor}>
                        <div className={styles.sectionAbout__div1__Parrafos}>
                            ...
                            <p className={styles.sectionAbout__div1__P}>Luego de terminar mis estudios diversificados comencé con mi aventura de aprendizaje y hoy te voy a contar sobre todo lo que e aprendido.</p>
                        </div>
