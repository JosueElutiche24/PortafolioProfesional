    ...
    return(
        <section className={styles.sectionAbout}>
            <div className={styles.sectionAbout__div1}>
                    ...
                    <div className={styles.sectionAbout__div1__Flexor}>
                        <div className={styles.sectionAbout__div1__Parrafos}>
                            ...
                            <p className={styles.sectionAbout__div1__P+ " tR_medium"}>Tengo 19 años, me gradué como bachiller hace 2 años, y hasta ahora todo lo que se sobre programación lo he aprendido por cuenta propia.</p>
                            <p className={styles.sectionAbout__div1__P+ " tR_medium"}>Mi experiencia es la que se ve reflejada en los proyectos que puedes encontrar en las próximas secciones.</p>
                            <p className={styles.sectionAbout__div1__P+ " tR_medium"}>Échate una visita por todo este sitio. Y si por cualquier cosa deseas contactarme, yo estaré feliz de recibir tu mensaje.</p>
                            <div className={styles.sectionAbout__div1__ContainerBtn}>
                                ...
                                <Link href="/contact"><a className={styles.sectionAbout__div1__Btn}>Contácteme</a></Link>
                            </div>
                        </div>
                        <div className={styles.sectionAbout__div1__IMGContainer}>
                            <img  className={styles.sectionAbout__div1__IMG} src="/myPhoto.jpeg" />
                        </div>
                    </div>
            </div>
            <div className={styles.sectionAbout__div2}>
                ...
                <br/>
                <p className={styles.sectionAbout__div2__pKnowledge+" tR_medium"}>Las tecnologías principales con las que trabajo son : Html5, Css, Tailwid, Javascript, Node js, Typescript, React, Next Js, Express, Nest, MongoDB y MySql.</p>
                ...
                <p className={styles.sectionAbout__div2__pKnowledge+" tR_medium"}>Actualmente estoy estudiando sobre patrones de diseño, Graphql y .Net(aunque en este ultimo aún soy un novato).</p>
